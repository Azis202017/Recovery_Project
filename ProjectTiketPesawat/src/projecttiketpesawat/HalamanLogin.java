...
public class HalamanLogin extends javax.swing.JFrame {
    ...
    public void login(){
        Usernama = username.getText();
        Password = password.getText();
        if (Usernama.equals("Abdul") && Password.equals("Azis")) {
            DaftarPesawat HlmnAwal = new DaftarPesawat();
            HlmnAwal.setVisible(true);
            dispose();
        }
        else{
         int Jawaban = JOptionPane.showConfirmDialog(this,"Username Atau Password Anda Salah,Apakah Anda Ingin Login Lagi? ");
         switch(Jawaban){
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projecttiketpesawat/images (1).png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Salah, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE))
        );
